...
from keypad2 import numPadList, operatorList
from constants import constantList, constantValues
...
class Calculator(QWidget):
    ...
    def buttonClicked(self):
        ...
        if key == '=':
            ...
            self.display.setText(self.display.text() + constantValues[constantList.index(key)][1])
